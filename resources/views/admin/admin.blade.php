                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{($admins->opd)}}</td>
                            <td>{{($admins->hp)}}</td>
                            <td><img src="{{url('image')}}/{{ $admins->foto}}"
                                    style="max-height:200px;max-width:200px;margin-top:10px;"></td>

                            <td>
                                <a href="/admin/{{$admins->id}}/edit" class="btn btn-warning btn-sm">Edit </a>
                                <a href="/admin/{{$admins->id}}/delete" class="btn btn-danger btn-sm"
                ...
                <form action="/admin/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="tempat" type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="Tempat Lahir">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">OPD</select>
                            <select name="opd" class="form-control" id="exampleFormControlSelect1">
                                ...
                                <option value="Dinas Komunikasi dan Informatika">Dinas Komunikasi dan Informatika
                                </option>
                            </select>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">HP</label>
                        <input name="hp" type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" placeholder="HP">
                    </div>
                    <style>
                        .gambar {
                            width: 200px;
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="foto" onchange="loadFile(event)" class="form-control-file"
                            id="exampleFormControlFile1">
                        <img src="" id="output" class="gambar" alt="">
                    </div>
